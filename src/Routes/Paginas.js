...
import DashboardLogs from "../Paginas/DashboardLogs";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route
          path="/dashboardNotificaciones"
          element={<DashboardNotificaciones />}
        />
        ...
        <Route path="/dashboardLogs" element={<DashboardLogs />} />
      </Routes>
    </BrowserRouter>
  );
};
